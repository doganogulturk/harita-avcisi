...
/** Ekranın asıl eylemi (Başla, Tekrar oyna): tam genişlikte, dolgun turkuaz tuş. */
export const PRIMARY_BUTTON_CLASS =
  "flex w-full shrink-0 items-center justify-center gap-2 rounded-2xl bg-cyan-600 px-6 py-3.5 text-lg font-bold text-white short:py-2.5 short:text-base lg:py-4 shadow-lg shadow-cyan-600/20 transition-all duration-200 hover:gap-3.5 hover:bg-cyan-500 active:scale-[0.98] focus-visible:ring-4 focus-visible:ring-cyan-200 focus-visible:outline-none disabled:cursor-wait disabled:opacity-50";
